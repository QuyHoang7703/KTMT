...
img = cv2.imread(r"D:\PyCharm-Project\pythonProject12\test\a.png")
...
#
# # Sắp xếp contours theo diện tích, lấy 5 contour lớn nhất
# contours = sorted(contours, key=cv2.contourArea, reverse=True)[:5]
#
# number_plate_shape = None
#
# # Lặp qua các contour để tìm hình chữ nhật có 4 đỉnh
# for c in contours:
...
#     # Xác định bounding box của hình chữ nhật
#     (x, y, w, h) = cv2.boundingRect(number_plate_shape)
#     # Cắt phần của ảnh mà hình chữ nhật bao quanh
